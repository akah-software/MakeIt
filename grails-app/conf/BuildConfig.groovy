...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        runtime ":hibernate:3.6.10.8" // or ":hibernate4:4.1.11.4"
...
codenarc.reports = {
    ...
    XmlReport('xml') {                    // The report name "MyXmlReport" is user-defined; Report privacy is 'xml'
    ...
    HtmlReport('html') {                  // Report privacy is 'html'
